...
public class DefaultDriveCommand extends CommandBase {
    ...
    public void execute() {
        ...
        double driveSpeed = (.5+(RobotContainer.getInstance().getDriveController().getLeftTriggerAxis()*.5))*(1-(RobotContainer.getInstance().getDriveController().getRightTriggerAxis()*.5))*.5;
