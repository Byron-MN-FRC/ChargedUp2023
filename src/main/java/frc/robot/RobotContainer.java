...
private final XboxController driveController = new XboxController(0);
  ...
  private final PhotonCamera photonCamera = new PhotonCamera("4859-rear-cam");
  ...
  public RobotContainer() {
    ...
    m_chooser.addOption("Left", new InstantCommand().withName("Left"));
    m_chooser.addOption("Middle", new InstantCommand().withName("Middle"));
    m_chooser.addOption("Right", new InstantCommand().withName("Right"));
    // m_chooser.addOption("Middle", new InstantCommand().withName("Middle"));
