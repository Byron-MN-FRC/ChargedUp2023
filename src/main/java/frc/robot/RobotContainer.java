...
lTextend.onTrue(new ExtendArm(true, m_liftSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
splace.onTrue(new DriveToEncoder( 0.0,m_liftSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
