...
m_chooser.addOption("path 3", new Path3(m_drivetrainSubsystem,m_liftSubsystem,m_clawSubsystem));
...
rBretract.onTrue(new RetractArm( m_liftSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
    ...
    final JoystickButton splace = new JoystickButton(attachmentController, XboxController.Button.kStart.value);        
splace.onTrue(new DriveToEncoder( m_liftSubsystem, 0.0 ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
