...
private final XboxController driveController = new XboxController(0);
  ...
  */
  ...
  public RobotContainer() {
    ...
    m_chooser.addOption("instant", new InstantCommand().withName("instant"));
    m_chooser.addOption("Delay", new InstantCommand().withName("Delay"));
...
lTextend.onTrue(new ExtendArm( m_liftSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
rBretract.onTrue(new RetractArm( m_liftSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
    ...
    // new Button(m_controller::getBackButton)
            ...
            final JoystickButton btnDrive2Point = new JoystickButton(driveController, XboxController.Button.kRightStick.value);
            btnDrive2Point.onTrue(new DriveToPoint(m_drivetrainSubsystem, (      TrajectoryGenerator.generateTrajectory(
...
SmartDashboard.putString("AutoMode", m_chooser.getSelected().getName());
    Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d(0)), List.of(new Translation2d(.2, 0), new Translation2d(0, 0)), new Pose2d(1, 1, new Rotation2d(0)), config);
    // if (m_chooser.getSelected().getName().equals("Delay")){
      exampleTrajectory =
    ...
    // else if(m_chooser.getSelected().getName().equals("instant")){
    //   exampleTrajectory =
    //   TrajectoryGenerator.generateTrajectory(
    //       // Start at the origin facing the +X direction
    //       new Pose2d(0, 0, new Rotation2d(0)),
