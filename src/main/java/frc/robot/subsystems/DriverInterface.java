...
public class DriverInterface extends SubsystemBase {
    ...
    */
    public DriverInterface() {
        ...
        SmartDashboard.putBoolean("lsLow", false); // Limit Switch Low Tested
        SmartDashboard.putBoolean("lsHigh", false);// Limit Switch High Tested

        SmartDashboard.putBoolean("April Tag Tested", false);
