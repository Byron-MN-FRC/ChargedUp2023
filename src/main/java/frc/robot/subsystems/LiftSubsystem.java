...
public double lowPos = 22000;
    ...
    */
// private Map<VerticalPosition, Integer> GrabPosition = new HashMap<VerticalPosition,Integer>();
public LiftSubsystem() {
    ...
    // GrabPosition.put(VerticalPosition.High, 1000);
    // GrabPosition.put(VerticalPosition.Middle, 500);
    // GrabPosition.put(VerticalPosition.Low, 250);
}
