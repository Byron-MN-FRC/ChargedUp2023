...
public double highPos = 218000.000000 + offset;
public double storedPos = 8200 + offset;
public double lowPos = 22000 + offset;
...
armExtender = new DoubleSolenoid(21, PneumaticsModuleType.REVPH, 2, 3);
 addChild("armExtender", armExtender);
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("leftLimitSwitchFwd", leftLifter.isFwdLimitSwitchClosed());
        SmartDashboard.putNumber("leftLimitSwitchRev", leftLifter.isRevLimitSwitchClosed());
        SmartDashboard.putNumber("EncoderUnits", leftLifter.getSelectedSensorPosition());
        SmartDashboard.putNumber("LowPosition", lowPos);
        ...
        highPos = 218000.000000 + offset;
        storedPos = 8200 + offset;
        lowPos = 22000 + offset;
    ...
    public void liftMotorConfig() {
        ...
        leftLifter.configForwardLimitSwitchSource(LimitSwitchSource.FeedbackConnector, LimitSwitchNormal.NormallyClosed,LifterConstants.kTimeoutMs);
        leftLifter.configReverseLimitSwitchSource(LimitSwitchSource.FeedbackConnector, LimitSwitchNormal.NormallyClosed,LifterConstants.kTimeoutMs);
