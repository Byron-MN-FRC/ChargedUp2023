...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(334.424 ); // FIXME Measure and set
                                                                                                // front left steer
                                                                                                // offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(6.504  ); // FIXME Measure and set
                                                                                               // front right steer
                                                                                               // offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(239.238); // FIXME Measure and set
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(66.182 ); // FIXME Measure and set
