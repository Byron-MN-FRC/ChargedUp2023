...
public final class Constants {
    ...
    //public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(335.479 ); // FIXME Measure and set
    //public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(109.512 ); // FIXME Measure and set
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(291.182 ); // FIXME Measure and set
    // public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(0.0); // FIXME Measure and set
   ...
   // public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(8.086   ); // FIXME Measure and set
    ...
    //public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(238.184 ); // FIXME Measure and set
   ...
   // public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(64.775 ); // FIXME Measure and set
