...
public final class Constants {
 ...
 //   public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(291.182); // FIXME Measure and set
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(111.182); // FIXME Measure and set
                                                                                                // front left steer
                                                                                                // offset
    // public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(0); // FIXME Measure and set
  ...
  //  public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(188.701); // FIXME Measure and set
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(8.701); // FIXME Measure and set
    // front right steer
                                                                                               // offset
    // public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(0); // FIXME Measure and set
  ...
  //  public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(254.531); // FIXME Measure and set
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(74.531); // FIXME Measure and set
    // back left steer offset
    // public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(0); // FIXME Measure and set
 ...
 //   public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(245.039); // FIXME Measure and set
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(65.039); // FIXME Measure and set
    // back right steer offset
    // public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(0); // FIXME Measure and set
