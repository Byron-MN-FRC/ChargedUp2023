...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(115.928 ); // FIXME Measure and set
                                                                                                // front left steer
                                                                                                // offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(9.404 ); // FIXME Measure and set
                                                                                               // front right steer
                                                                                               // offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(72.861 ); // FIXME Measure and set
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(64.863 ); // FIXME Measure and set
